...
sidebar_expander("Streamlit Introduction", """
...
Let's call it `Home Page.py` then paste the code from below (_don't worry, we'll understand it all later_).
Thereafter, open terminal and activate your virtual environment. Then run `streamlit run Home Page.py`
""")
st.code("""
import streamlit as st
...
add_navigation(next_page="Headings.py", next_page_title="Headings")
